...
FORMATO JSON EXIGIDO:
{
  ...
  "timeline": [
    { "chapter": "Resumo do Livro", "event": "Um resumo único, altamente detalhado e completo em vários parágrafos do enredo do livro inteiro, principais eventos e desfecho (máx. 2000 caracteres)" }
  ]
}]],
